...
class TestMongoBlacklistImpl(unittest.TestCase):
    ...
    def test_batch_add_to_blacklist(self) -> None:
        """测试批量添加股票到黑名单"""
        records = [
            {"user_id": TEST_USER_ID, "code": "000001", "add_time": "2026-06-21 10:00:00"},
            {"user_id": TEST_USER_ID, "code": "600519", "add_time": "2026-06-21 10:00:00"},
            {"user_id": TEST_USER_ID, "code": "000858", "add_time": "2026-06-21 10:00:00"},
        ]
    ...
    def test_remove_from_blacklist(self) -> None:
        ...
        self.impl.add_to_blacklist({
            "user_id": TEST_USER_ID, "code": "300750", "add_time": "2026-06-21 10:00:00",
        })
        # 确认存在
