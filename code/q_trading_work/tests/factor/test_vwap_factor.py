...
from factor.vwap_factor import (
    VwapFactor
)


class TestVwapFactor(unittest.TestCase):
    """
    因子测试
    """
    ...
    def test_vwap_factor(self) -> None:
        """
        测试涨幅百分比
        """

        factor = VwapFactor(days=5)
        code = "603993"
        start_time = "2026-08-14 13:00:00"
