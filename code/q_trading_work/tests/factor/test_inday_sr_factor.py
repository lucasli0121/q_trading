...
class TestIndaySRFactor(unittest.TestCase):
    """
    因子测试
    """
    ...
    def test_inday_sr_factor(self) -> None:
        """
        测试 inday_support支撑阻力因子
        """
        code = "603986"
        df = self.load_his_daily_data(code, 15)
        factor = InDaySRFactor(days=5)
